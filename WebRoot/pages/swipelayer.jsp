...
<link rel="stylesheet" href="../ol3/bootstrap-responsive.css"
	type="text/css">
<link rel="stylesheet" type="text/css" href="../easyui/easyui.css">
<link rel="stylesheet" type="text/css" href="../easyui/icon.css">
<link rel="stylesheet" type="text/css" href="../easyui/demo.css">
<script type="text/javascript" src="../js/swipelayer.js"></script>
...
<script type="text/javascript">
	...
	function formatInputs_2(val, row) {
		return "<a href='javascript:void(0);'  onclick='setLayerSource_2(\""
				+ row.name + "\")';" + ">" + "加载" + "</a>";
	}
...
<body onload="init('test:work1','test:work5')" 	background="../ol3/textured_paper.jpeg">
	<a onclick="showCatalog();" class="easyui-linkbutton" >目录</a>
	<div id="map" class="map"></div>
	<!-- 					<input id="swipe" type="range" style="width:100%"> -->
	<input id="swipe" class="easyui-slider" style="width:100%" value="50"
		data-options="
						onChange: function(){
						refreshMap();
					}">
		...
		<table class="easyui-datagrid" id="tableCal" url="easyuUIGetCal"
			...
			<thead>
				<tr>
					...
					<th data-options="field:'os1',width:100,formatter:formatInputs_1">底层</th>
					<th data-options="field:'os2',width:100,formatter:formatInputs_2">上层</th>
				</tr>
			</thead>
		</table>
	</div>
