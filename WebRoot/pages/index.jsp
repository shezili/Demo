...
<body  style="height: 100%">
	<div class="easyui-layout" style="width:100%;height:100%">
		<div data-options="region:'north'" style="height:7%;background-color:#0595DE"></div>
		<div data-options="region:'south',split:true" style="height:7%;background-color:#0595DE"></div>
		<div data-options="region:'east',split:true" title="图层选择" style="width:15%;height:86%">
<!-- 			<p id="layerList"></p> -->
			<iframe id="innerpageEast" name="childPageEast" src="eastLayerList.jsp"  height = "99%" width = "98%"></iframe>
		</div>
		<div data-options="region:'west',split:true" data-options="selected:true" title="功能选项" style="width:15%;height:86%">
			<div class="easyui-accordion" data-options="fit:true,border:false">
				<div title="成果浏览" style="padding:10px;">
					<table class="easyui-datagrid" style="width:170px;height:220px">
						<thead>
							<tr>
